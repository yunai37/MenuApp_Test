...
public class PostWish extends AsyncTask<String, Void, String> {
    ProgressDialog progressDialog;
    Context context;
    PostWish(Context context){
    ...
    protected void onPostExecute(String result) {
        ...
        Log.d("PostWish", "POST response - " + result);
    }
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            Log.d("PostWish", "InsertData : Error ", e);
